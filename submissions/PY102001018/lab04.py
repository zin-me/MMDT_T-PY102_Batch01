...
def build_submission_tree(submissions: str, PY102001018: str, PY102001002: str) -> TreeNode:
    """
    ...
    f1_node = TreeNode(PY102001018)
    f2_node = TreeNode(PY102001002)

    root.left = f1_node
    root.right = f2_node

    f1_node.left = TreeNode(f"{PY102001018}/lab00.py")
    f1_node.right = TreeNode(f"{PY102001018}/lab01.py")

    f1_node.left.left = TreeNode(f"{PY102001018}/lab02.py")
    f1_node.left.right = TreeNode(f"{PY102001018}/lab03.py")

    f2_node.left = TreeNode(f"{PY102001002}/lab00.py")
    f2_node.right = TreeNode(f"{PY102001002}/lab01.py")

    f2_node.left.left = TreeNode(f"{PY102001002}/lab02.py")
