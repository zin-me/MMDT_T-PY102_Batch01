...
# ============================================================
def reverseList(head): # only head , with chain
    """
    LeetCode 206 — Reverse Linked List
...
#my_llist = SinglyLinkedList.from_list(numbers)

#double_head = doubleIt(my_llist.head)

#result = SinglyLinkedList(double_head)
